# 第35章 Agentic OS——为什么 Agent 将重新定义操作系统？
...
这一雏形正是第34章 Persistent World、Capability Registry 与本章 Event First 思想的结合体。
...
想亲手实现一个最小的 Capability Registry 和事件驱动系统，理解"Capability First"与"Event First"，可以看这一节实验：**35.1 亲手实现一个最小 Capability Registry——用事件驱动的方式理解 Agentic OS**。
...
从第23章的"为什么大模型开始行动"，到本章的"Agent 将如何重新定义操作系统"，我们完整走过了 Agent 从"拥有工具"到"拥有记忆"到"拥有自主循环"，再到"多Agent 协作"，最终"拥有统一运行平台"的演进路径：
