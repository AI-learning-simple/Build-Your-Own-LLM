...
这一雏形正是第13章 Persistent World、Capability Registry 与本章 Event First 思想的结合体。
...
想亲手实现一个最小的 Capability Registry 和事件驱动系统，理解"Capability First"与"Event First"，可以看这一节实验：**14.1 亲手实现一个最小 Capability Registry——用事件驱动的方式理解 Agentic OS**。
