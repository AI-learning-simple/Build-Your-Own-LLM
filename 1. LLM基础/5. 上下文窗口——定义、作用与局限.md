...
- [实验 5.2：实现第一个 N-Gram 语言模型](./5.2%20实现%20N-Gram%20语言模型.md)：汇总计数、计算条件概率，并观察未见 Context 为什么会让模型“哑火”。

完成两项实践后，再进入 [第 6 章：从 N-Gram 到 Neural Language Model](./6.%20神经语言模型——从%20N-Gram%20到分布式表示.md)。
