...
即使只有一张 8GB 显卡，也可以亲手体验 Accelerate 与 DeepSpeed ZeRO 的分布式训练配置，感受"分布式"思想如何在单卡上工作：**7.1 亲手用 Accelerate + DeepSpeed ZeRO 体验分布式训练配置——即使只有一张卡**。
...
- Chip Huyen《AI Engineering》（训练/推理工程全景）：https://github.com/chiphuyen/ai-engineer-book
